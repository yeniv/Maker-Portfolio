export const projectsData = [
  // WAL-LE
  {
    ...
    fullDescription: 
      <div>
        <p>
          An 11-minute documentary following a team of engineers building an amphibious vehicle prototype for the Canadian Armed Forces
        </p>
        <p>
    ...
    imageGallery: [
      '/images/WAL-LE/WAL-LE-web-gallery-1.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-2.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-3.jpg', 
      // '/images/WAL-LE/WAL-LE-web-gallery-4.jpg', 
      // '/images/WAL-LE/WAL-LE-web-gallery-5.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-7.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-10.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-6.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-8.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-12.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-14.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-17.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-15.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-18.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-11.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-19.jpg', 
      // '/images/WAL-LE/WAL-LE-web-gallery-9.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-13.jpg', 
      // '/images/WAL-LE/WAL-LE-web-gallery-20.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-21.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-22.jpg', 
      '/images/WAL-LE/WAL-LE-web-gallery-16.jpg', 
    ]
  },
  // PORTRAIT 2 - HAPPY BIRTHDAY (FEATURED)
  {
    id: 'portrait-2',
    featured: true,
    category: 'portraits',
  ...
  // YOUNG SPIKES: STITCHED TOGETHER
  {
    ...
    imageGallery: [
      ...
      '/images/Stitched-Together/Stitched-Together-web-gallery-4.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-5.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-6.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-7.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-8.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-9.jpg',
      '/images/Stitched-Together/Stitched-Together-web-gallery-10.jpg',
    ],
    imageGalleryCols: 1
  },
  // TROOPL
  ...
  // YOUNG LIONS: CHANGE YOUR PERSPECTIVE
  {
  ...
  // HCG
  {
    ...
    fullDescription:
      <div>
        ...
        <p>We teamed up with comedy duo Fitzy & Wippa to create the first HCG commentary team.</p>
  ...
  // PORTRAIT 11 - ARIEL ON BALCONY (FEATURED)
  {
    id: 'portrait-11',
    featured: true,
    category: 'portraits',
  ...
  // PORTRAIT 24
  {
    ...
    featured: false,
    category: 'portraits',
    thumbnail: '/images/Portraits/portrait-thumbnail-24.jpg',
    mainImage: '/images/Portraits/portrait-main-24.jpg',
  },
  // PORTRAIT 8
  {
    id: 'portrait-8',
  ...
  // ANYTHING HELPS
  {
    ...
    imageGallery: [
      '/images/Anything-Helps/Anything-Helps-web-gallery-1.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-2.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-3.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-4.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-5.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-6.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-7.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-8.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-9.jpg',
      '/images/Anything-Helps/Anything-Helps-web-gallery-10.jpg',
    ]
  },
  // PORTRAIT 4 - ANDREW TOILET (FEATURED)
  {
    id: 'portrait-4',
    featured: true,
    category: 'portraits',
